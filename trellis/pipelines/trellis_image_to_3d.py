...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def sample_sparse_structure_single_step(
        self,
        latent, 
        extract_time: int,
        cond: dict,
        ...
        for i in range(sample_time):
            ...
            if total_extract_features is None:
                ...
                total_extract_features = [total + curr for total, curr in zip(total_extract_features, current_features)]

        average_features = [item / sample_time for item in total_extract_features]
    ...
    def run_latent_single_step(
        ...
        average_features = [item / cond_len for item in total_extract_features]
        return average_features
