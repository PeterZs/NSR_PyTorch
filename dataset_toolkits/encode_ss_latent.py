...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_pretrained', type=str, default='/db-mnt/mnt/efs-mount/home/keyudu/data/checkpoint/trellis/models--microsoft--TRELLIS-image-large/snapshots/25e0d31ffbebe4b5a97464dd851910efc3002d96/ckpts/ss_enc_conv3d_16l8_fp16',
    ...
    try:
        for sha256 in sha256s:
            try:
                ...
                save_path = os.path.join('/db-mnt/mnt/efs-mount/home/keyudu/data/trellis/dataset/latent', 'ss_latents', latent_name, f'{sha256}.npz')
